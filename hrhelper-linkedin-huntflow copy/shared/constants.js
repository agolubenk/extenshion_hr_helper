...
(function () {
  ...
  /** Гибкие настройки: Google Drive — показывать плавающее окно по типу приложения */
  g.__HRH__.GDRIVE_FLOATING_APPS_KEY = "hrhelper_gdrive_floating_apps";
  g.__HRH__.DEFAULT_GDRIVE_FLOATING_APPS = {
    drive: true,     // drive.google.com (file/open)
    docs: true,      // docs.google.com/document
    sheets: true,    // docs.google.com/spreadsheets
    slides: true,    // docs.google.com/presentation
    forms: true,     // docs.google.com/forms
    other: true,     // неизвестные/прочие страницы в пределах матчей
  };
